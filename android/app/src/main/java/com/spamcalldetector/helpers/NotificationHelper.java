...
// import com.spamcalldetector.receivers.ActionReceiver;
...
// String callerName =
// ContactsHelper.getContactNameByPhoneNumber(callerPhoneNumber, context);
...
// NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Incoming
// Call Notification",
...
// Intent incomingCallIntent = new Intent(context, CallActivityModule.class);
// incomingCallIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
// Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);
// PendingIntent incomingCallPendingIntent;
// incomingCallPendingIntent = PendingIntent.getActivity(context, 0,
// incomingCallIntent,
...
// pickUpCallYesPendingIntent = PendingIntent.getBroadcast(context, 1,
// answerCallIntent,
// PendingIntent.FLAG_MUTABLE);
...
// pickUpCallNoPendingIntent = PendingIntent.getBroadcast(context, 2,
// rejectCallIntent,
// PendingIntent.FLAG_MUTABLE);
...
// builder.addAction(R.drawable.ic_call_green, "Answer",
// pickUpCallYesPendingIntent);
// builder.addAction(R.drawable.ic_call_end_red, "Reject",
// pickUpCallNoPendingIntent);
...
// public static void createIngoingCallNotification(Context context, Call call,
// String callDuration,
...
// callerName = ContactsHelper.getContactNameByPhoneNumber(callerPhoneNumber,
// context);
// }

// String CHANNEL_ID = "Hidden_Pirates_Phone_App";

// NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Ingoing
// Call Notification",
// NotificationManager.IMPORTANCE_DEFAULT);
// channel.setLockscreenVisibility(Notification.VISIBILITY_PUBLIC);
...
// Intent ingoingCallIntent = new Intent(context, CallActivityModule.class);
// ingoingCallIntent.setFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT |
// Intent.FLAG_ACTIVITY_NEW_TASK);

// PendingIntent ingoingCallPendingIntent;

// ingoingCallPendingIntent = PendingIntent.getActivity(context, 0,
// ingoingCallIntent, PendingIntent.FLAG_MUTABLE);
...
// endCallPendingIntent = PendingIntent.getBroadcast(context, 1, endCallIntent,
// PendingIntent.FLAG_MUTABLE);
...
// speakerCallPendingIntent = PendingIntent.getBroadcast(context, 2,
// speakerCallIntent,
// PendingIntent.FLAG_MUTABLE);
...
// muteCallPendingIntent = PendingIntent.getBroadcast(context, 3,
// muteCallIntent, PendingIntent.FLAG_MUTABLE);
...
// builder.setCategory(Notification.CATEGORY_CALL);
// builder.setChannelId(CHANNEL_ID);
// builder.addAction(R.drawable.ic_call_end_red, "End Call",
// endCallPendingIntent);
// builder.addAction(R.drawable.ic_volume_up, speakerBtnTxt,
// speakerCallPendingIntent);
// builder.addAction(R.drawable.ic_volume_up, muteBtnTxt,
...
// NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Outgoing
// Call Notification",
// NotificationManager.IMPORTANCE_DEFAULT);
// channel.setLockscreenVisibility(Notification.VISIBILITY_PUBLIC);
...
// Intent outingCallIntent = new Intent(context, CallActivityModule.class);
// outingCallIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
// Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);

// PendingIntent outgoingCallPendingIntent;

// outgoingCallPendingIntent = PendingIntent.getActivity(context, 0,
// outingCallIntent, PendingIntent.FLAG_MUTABLE);
...
// builder.setCategory(Notification.CATEGORY_CALL);
// builder.setChannelId(CHANNEL_ID);
// builder.addAction(R.drawable.ic_call_end_red, "Cancel",
// pickUpCallYesPendingIntent);
